...
@section('content')
    <
        <div class="max-w-4xl mx-auto bg-white p-6 rounded-lg shadow-md mt-10">
            <h2 class="text-2xl font-bold mb-6">Créer une promotion</h2>
            ...
            <form action="{{ route('promotion.store') }}" method="POST" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="text" name="promotion_code" placeholder="Code de promotion" class="w-full p-2 border-gray-300 rounded-lg bg-gray-100 focus:ring-2 focus:ring-blue-500">
