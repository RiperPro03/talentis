...
@section('content')
    <div class="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-xl mt-10 space-y-6">
        ...
        <h2 class="text-3xl font-bold text-center mb-6">Créer une entreprise</h2>
        ...
        <form action="{{ route('pilot.company.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" placeholder="Nom de l'entreprise"
                           class="input input-bordered w-full">
                </div>

                <div>
                    <label class="label font-medium">Email</label>
                    <input type="email" name="email" value="{{ old('email') }}" placeholder="exemple@entreprise.com"
                           class="input input-bordered w-full">
                </div>

                <div>
                    <label class="label font-medium">Numéro de téléphone</label>
                    <input type="text" name="phone_number" value="{{ old('phone_number') }}" placeholder="0567778729"
                           class="input input-bordered w-full">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="postal_code" value="{{ old('postal_code') }}" placeholder="Ex : 98713"
                           class="input input-bordered w-full">
                </div>

                <div>
                    <label class="label font-medium">Ville</label>
                    <input type="text" name="city" value="{{ old('city') }}" placeholder="Ex : Papeete"
                           class="input input-bordered w-full">
                </div>
            </div>
            ...
            <div>
                ...
                <textarea name="description" rows="4" placeholder="Présentation de l'entreprise"
