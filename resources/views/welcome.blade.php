<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" html data-theme="mytheme">
    <head>
        <meta charset="utf-8">
    ...
    <body class="font-sans antialiased bg-slate-100">
        ...
        <main class="p-6 text-neutral text-center">
            ...
            <!-- 📌 SEARCH BAR (Optimisée pour mobile-first) -->
            <div class="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-4 bg-white p-6 shadow-lg rounded-lg w-full max-w-4xl mx-auto mt-4">
                <!-- Input: Vous cherchez ? -->
            ...
            <div class="relative w-full max-w-6xl mx-auto mt-6">
                ...
                <button id="prev" class="hidden lg:flex absolute left-0 top-1/2 transform -translate-y-1/2 btn btn-circle btn-primary">❮</button>
                <button id="next" class="hidden lg:flex absolute right-0 top-1/2 transform -translate-y-1/2 btn btn-circle btn-primary">❯</button>
            </div>
        ...
        <footer class="footer footer-center bg-white text-base-content p-4 mt-6">
            <aside>
                <p>Copyright © 2025 - All rights reserved by Talentis</p>
            </aside>
        </footer>
